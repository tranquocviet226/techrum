...
// core components
import Button from 'components/admin/common/CustomButtons/Button';
import GridItem from 'components/admin/common/Grid/GridItem';
import GridContainer from 'components/admin/common/Grid/GridContainer';
import Table from 'components/admin/common/Table/Table';
import Tasks from 'components/admin/common/Tasks/Tasks';
import CustomTabs from 'components/admin/common/CustomTabs/CustomTabs';
import Danger from 'components/admin/common/Typography/Danger';
import Card from 'components/admin/common/Card/Card';
import CardHeader from 'components/admin/common/Card/CardHeader';
import CardAvatar from 'components/admin/common/Card/CardAvatar';
import CardIcon from 'components/admin/common/Card/CardIcon';
import CardBody from 'components/admin/common/Card/CardBody';
import CardFooter from 'components/admin/common/Card/CardFooter';
import SnackbarContent from 'components/admin/common/Snackbar/SnackbarContent';
